<?php
 ...
 $tampil     = (isset($_SESSION['tampil'])) ? $_SESSION['tampil'] : "";
	...
	while ( $dataRow = mysqli_fetch_array( $rResult ) )
	{
        ...
        $masihberlaku		= $dataRow['masihberlaku'];
        $tdkberlaku		    = $dataRow['tdkberlaku'];
        $total              = $tdkberlaku + $masihberlaku;

       $row = array($no,$masihberlaku,$tdkberlaku,$total); 
