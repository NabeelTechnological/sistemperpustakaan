...
<form action="export.php?lap=koleksibukureferensi&page=<?= basename($_SERVER["SCRIPT_FILENAME"])?>" method="post" class="form-horizontal" data-validate="parsley" role="form"  name="form1">
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Koleksi Kode Klasifikasi</div>
    </div>
   ...
   <div class="form-body">
       <div class="form-group">
          <label class="col-lg-2 control-label">Kode klasifikasi</label>
            <div class="col-lg-5">
                <select name="txtSubyek" data-placeholder="- Pilih Klasifikasi -" class="select2me form-control" required>
                    <option value=""></option>
                    <?php
...
$qry = "SELECT count(*) FROM tbuku WHERE kode LIKE ? AND idjnsbuku = 3 AND noapk = $_SESSION[noapk]";
...
$qry = "SELECT count(*) FROM tbuku WHERE idjnsbuku = 3 AND noapk = $_SESSION[noapk]";
$stmt = mysqli_prepare($koneksidb,$qry);
mysqli_stmt_execute($stmt);
