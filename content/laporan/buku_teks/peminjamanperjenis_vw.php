...
<form action="export.php?lap=bukuteks_peminjamanperjenis&page=<?= basename($_SERVER["SCRIPT_FILENAME"])?>" method="post" class="form-horizontal" data-validate="parsley"  name="form1">
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Rekap Peminjaman Buku Per Jenis Untuk Buku Teks</div>
        <div class="tools">
	    ...
	    <div class="row">
	        <div class="form-group">
	            <div class="col-lg-offset-2 col-lg-10">
	            	<!-- <button type="submit" name="btnSave" value="tampilPerKlasifikasi" class="btn blue"><i class="fa fa-check"></i> Tampilkan Per Klasifikasi</button> -->
                    <button type="submit" name="btnSave" value="tampilPerJenis" class="btn blue"><i class="fa fa-check"></i> Tampilkan Per Jenis Buku</button>
...
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
      <div class="caption">Data Peminjaman Per Jenis Untuk Buku Teks</div>
      <div class="actions">
    ...
    <div class="portlet-body fieldset-form">
        ...
        <thead>
          <tr class="active"> 
            <td width="3%">NO</td>
            <?php if($_SESSION['tampil']=="tampilPerKlasifikasi"){?>
                <td><div align="center">KODE KLASIFIKASI</div></td>
           <?php } ?>
                <td><div align="center">DESKRIPSI</div></td>
                <td><div align="center">JUMLAH PEMINJAMAN</div></td> 
          </tr>
        </thead>
