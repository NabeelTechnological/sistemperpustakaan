...
<form action="export.php?lap=koleksipustaka_peminjamanperjenis&page=<?= basename($_SERVER["SCRIPT_FILENAME"])?>" method="post" class="form-horizontal" data-validate="parsley"  name="form1">
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Rekap Peminjaman Buku Per Klasifikasi Untuk Koleksi Perpustakaan</div>
        <div class="tools">
...
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
      <div class="caption">Data Peminjaman Per Jenis Untuk Koleksi Perpustakaan</div>
      <div class="actions">
