...
if(isset($_POST['del'])){
    ...
    // }else {
        ...
        $insQry = "DELETE FROM rkelas WHERE idkelas = ? AND noapk = $_SESSION[noapk]";
...
<!-- <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal"> -->
  <div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Data Kelas</div>
        <div class="actions">
            <a href="?content=tambahkelas" class="btn  <?= $_SESSION['warnatombol'] ?>"><i class="fa fa-plus-circle"></i> Tambah Data</a>  
        </div>
    </div>
