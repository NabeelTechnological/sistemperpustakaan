...
//security goes here 
  if(isset($_POST['del'])){
    ...
    //         </div>";
    // }else {
    $insQry = "DELETE FROM rtbuku WHERE idbuku = ? AND noapk = $_SESSION[noapk]";
		...
		mysqli_stmt_execute($stmt) or die ("Gagal Query Hapus Update Buku : " . mysqli_error($koneksidb));
...
<!-- <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal"> -->
  <div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Update Jenis Buku</div>
    </div>
