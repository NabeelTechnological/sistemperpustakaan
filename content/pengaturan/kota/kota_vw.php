...
$noapk  = $_SESSION['noapk'];
  if(isset($_POST['del'])){
    ...
    //         </div>";
    // }else {
    $insQry = "DELETE FROM rkota WHERE idkota = ? AND noapk = $_SESSION[noapk]";
...
<!-- <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal"> -->
  <div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Data Seting Nama Kota</div>
        <div class="actions">
            <a href="?content=tambahkota" class="btn  <?= $_SESSION['warnatombol'] ?>"><i class="fa fa-plus-circle"></i> Tambah Data</a>  
        </div>
    </div>
