...
$noapk  = $_SESSION['noapk'];
  ...
  if(isset($_POST['del'])){
    ...
    //         </div>";
    // }else {
    $insQry = "DELETE FROM rpenerbit WHERE idpenerbit = ? AND noapk = $_SESSION[noapk]";
		...
		mysqli_stmt_execute($stmt) or die ("Gagal Query Hapus Penerbit : " . mysqli_error($koneksidb));
		mysqli_stmt_close($stmt);
    
    logTransaksi($iduser, date('Y-m-d H:i:s'), 'Data Penerbit Dihapus', $noapk);
...
<!-- <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal"> -->
  <div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Daftar Penerbit</div>
        <div class="actions">
            <a href="?content=tambahpenerbit" class="btn  <?= $_SESSION['warnatombol'] ?>"><i class="fa fa-plus-circle"></i> Tambah Data</a>  
        </div>
    </div>
