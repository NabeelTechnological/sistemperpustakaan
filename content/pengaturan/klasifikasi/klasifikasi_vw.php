...
$noapk  = $_SESSION['noapk'];
  ...
  if(isset($_POST['del'])){
    ...
    //         </div>";
    // }else {
    $insQry = "DELETE FROM rsubyek WHERE kode = ? AND noapk = $_SESSION[noapk]";
		...
		mysqli_stmt_execute($stmt) or die ("Gagal Query Hapus Klasifikasi : " . mysqli_error($koneksidb));
		mysqli_stmt_close($stmt);

    logTransaksi($iduser, date('Y-m-d H:i:s'), 'Data Pengelompokkan Dihapus', $noapk);
...
<!-- <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal"> -->
  <div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Daftar Pengelompokan Buku</div>
        <div class="actions">
            <a href="?content=tambahklasifikasi" class="btn  <?= $_SESSION['warnatombol'] ?>"><i class="fa fa-plus-circle"></i> Tambah Data</a>  
        </div>
    </div>
