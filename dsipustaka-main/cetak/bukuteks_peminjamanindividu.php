...
if ($harian != "" && $pilihan == "harian") {
    ...
    $sheet->setCellValue('A4', "TRANSAKSI PEMINJAMAN BUKU TEKS");  
...
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    ...
    header('Content-Disposition: attachment; filename="Laporan Peminjaman Individu Buku Teks.xlsx"'); // Set nama file excel nya
