...
// DATABASE PREPARATION
    ...
    $sheet->setCellValue('A3',  "LAPORAN BUKU TEKS MASIH DIPINJAM" ); // Set kolom  
...
header('Content-Disposition: attachment; filename="Daftar Pustaka Terpinjam Buku Teks.xlsx"'); // Set nama file excel nya
