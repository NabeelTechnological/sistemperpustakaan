...
// DATABASE PREPARATION
    ...
    $sheet->setCellValue('A3',  "LAPORAN ".$jnslaporan." PEMINJAMAN BUKU KOLEKSI PERPUSTAKAAN" ); // Set kolom  
...
header('Content-Disposition: attachment; filename="Laporan Peminjaman Per Anggota Buku Koleksi Perpustakan.xlsx"'); // Set nama file excel nya
