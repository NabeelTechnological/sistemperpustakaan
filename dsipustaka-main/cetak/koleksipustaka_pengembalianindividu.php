...
if ($harian != ""  && $pilihan = "harian") {
    ...
    $sheet->setCellValue('A4', "TRANSAKSI PENGEMBALIAN BUKU KOLEKSI PERPUSTAKAAN");  
...
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    ...
    header('Content-Disposition: attachment; filename="Laporan Pengembalian Individu Buku Koleksi Perpustakaan.xlsx"'); // Set nama file excel nya
