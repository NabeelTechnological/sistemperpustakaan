...
<form action="export.php?lap=rekapdenda&page=<?= basename($_SERVER["SCRIPT_FILENAME"])?>" method="post" class="form-horizontal" data-validate="parsley"  name="form1">
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
        <div class="caption">Rekapitulasi Denda</div>
        <div class="tools">
...
<div class="portlet box <?= $_SESSION['warnabar'] ?>">
    <div class="portlet-title">
      <div class="caption">Data Rekapitulasi Denda</div>
      <div class="actions">
    ...
    <div class="portlet-body fieldset-form">
        ...
        <thead>
            <tr class="active"> 
                <td colspan="3"><div align="center">DENDA BUKU</div></td>
            </tr>
            <tr class="active"> 
                <td width="3%">NO</td>
