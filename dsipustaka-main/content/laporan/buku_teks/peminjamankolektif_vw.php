...
?>
<form action="export.php?lap=bukuteks_peminjamankolektif&page=<?= basename($_SERVER["SCRIPT_FILENAME"]) ?>" method="post" class="form-horizontal" data-validate="parsley" name="form1">
    <div class="portlet box <?= $_SESSION['warnabar'] ?>">
        <div class="portlet-title">
            <div class="caption">Laporan Peminjaman Buku Kolektif</div>
            <div class="tools">
...
?>
    ...
    <div class="portlet box <?= $_SESSION['warnabar'] ?>">
        <div class="portlet-title">
            <div class="caption">Data Laporan Peminjaman Buku Kolektif</div>
            <div class="actions">
            ...
            <table class="table table-condensed table-bordered table-hover" id="sample_2" width="100%">
                <thead>
                    <tr class="active">
                            ...
                            <td><div align="center">ID ANGGOTA</div></td>
                            <td><div align="center">NAMA PEMINJAM</div></td>
                            <td><div align="center">JUDUL BUKU</div></td>
                            <td><div align="center">JUMLAH</div></td>
                            <td><div align="center">PINJAM</div></td>
                            <td><div align="center">KEMBALI</div></td>
                        </tr>
                </thead>
            </table>
        </div>
