...
?>
<form action="export.php?lap=bukuteks_peminjamanperanggota&page=<?= basename($_SERVER["SCRIPT_FILENAME"]) ?>" method="post" class="form-horizontal" data-validate="parsley" name="form1">
    <div class="portlet box <?= $_SESSION['warnabar'] ?>">
        <div class="portlet-title">
            <div class="caption">Daftar Peminjaman Per Anggota untuk Buku Teks </div>
            <div class="tools">
...
?>
    ...
    <div class="portlet box <?= $_SESSION['warnabar'] ?>">
        <div class="portlet-title">
            <div class="caption">Data Peminjaman Per Anggota Buku Teks</div>
            <div class="actions">
        ...
        <div class="portlet-body fieldset-form">
            <table class="table table-condensed table-bordered table-hover" id="sample_2" width="100%">
                <thead>
                    <tr class="active">
                            <td width="3%">NO</td>
                            <td><div align="center">TGL PINJAM</div></td>
                            <td><div align="center">TGL KEMBALI</div></td>
