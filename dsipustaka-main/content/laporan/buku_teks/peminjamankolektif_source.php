...
$sTable = "(SELECT a.noapk, a.judul AS judul, b.idbuku AS idbuku, b.tglpinjam AS tglpinjam, b.tglkembali AS tglkembali, b.idkelas AS idkelas, b.nipnis AS nipnis, b.jmlpinjam AS jmlpinjam, c.nama AS nama
...
while ($dataRow = mysqli_fetch_array($rResult)) {
        ...
        $tglkembali = $dataRow['tglkembali'];
            ...
            $row = array($no, $idbuku, $idkelas, $nipnis, $nama, $judul, $jmlpinjam, $tglpinjam, $tglkembali);
