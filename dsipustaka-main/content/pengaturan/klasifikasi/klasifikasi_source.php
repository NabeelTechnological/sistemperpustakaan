...
$aksi 	  = "<a href=?content=ubahklasifikasi&id=".urlencode($kode)." class='btn btn-xs ".$_SESSION['warnatombol']." tooltips' data-placement='top' data-original-title='Edit'><i class='fa fa-edit'></i></a>".
	    	"<button data-toggle='modal' data-target='#deleteConfirmationModal' data-id='$kode' class='delPopUp btn btn-xs ".$_SESSION['warnatombol']." tooltips' data-placement='top' data-original-title='Delete'><i class='fa fa-trash-o' ></i></button>"; 
	     
	    //CEK Hari Libur
		$row = array( $no, $kode, $subyek, $aksi); 
