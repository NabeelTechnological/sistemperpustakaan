...
// DATABASE PREPARATION
    ...
    $sWhere = " WHERE kode LIKE '$subyek%' AND idjnsbuku = 3";
    ...
    $sheet->setCellValue('A3',  "LAPORAN KOLEKSI BUKU REFERENSI" ); // Set kolom  
...
header('Content-Disposition: attachment; filename="Koleksi Buku Referensi ['.$subyek.'00].xlsx"'); // Set nama file excel nya
