...
if($tampil == "tampilPerKlasifikasi"){
    ...
    $sheet->setCellValue('A3',  "LAPORAN $jdl JUMLAH PEMINJAMAN BUKU TEKS" ); // Set kolom  
...
if($tampil=="tampilPerKlasifikasi"){
    header('Content-Disposition: attachment; filename="Rekap Peminjaman Per Klasifikasi Buku Teks.xlsx"'); // Set nama file excel nya

}else if($tampil=="tampilPerJenis"){
    header('Content-Disposition: attachment; filename="Rekap Peminjaman Per Jenis Buku Teks.xlsx"'); // Set nama file excel nya
